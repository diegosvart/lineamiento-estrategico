...
| JTI — Jefe de Area TI              | Gustavo Contreras              |
| ARI — Adm. Redes e Infraestructura | Rafael García                  |
| SPT — Soporte Técnico              | Miguel Pimentel                |
| CE — Consultor ERP                 | Alexi (fuente de conocimiento) |

---

## Gateways

| Gateway | Condicion                                                          | Fecha proyectada |
| ------- | ------------------------------------------------------------------ | ---------------- |
