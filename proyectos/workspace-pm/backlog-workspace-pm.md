...
Este backlog complementa `planificacion/backlog.md` (fuente técnica) con una vista priorizada de las líneas de trabajo del Workspace PM. No duplica el contenido técnico — enlaza a él.
...
| Reporte RAG semanal automatizado | Fase 3 | Media | Pendiente | — |

---

## Por planificar

Iniciativas sin plan formal aún:

- Automatización reporte semanal (RAG) desde vault
- Onboarding de nuevos proyectos al workspace
- Ciclo de revisión mensual del stack de herramientas
