...
| Iniciativa | Lineamiento | Prioridad | Notas |
|------------|-------------|-----------|-------|
...
## En Planificación (borrador activo)

> Planes con estado `borrador` — en proceso de completarse.

*(vacío — agregar cuando Codex inicie un plan)*
...
| Cierre HH marzo + control PR + skill principal por agente | L1 | `planificacion/2026-03-31-cierre-hh-marzo-control-pr-y-skills-plan.md` | Urgente 31-03: vault cierra HH marzo, planning activa gate PR y skill por frente |
